<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="REGISTRaSI.Login" %>
...
<body>
        <form id="form1" runat="server">
            <h1 style="font-family: Poppins; color: white; text-align: center; font-size: 36px; text-shadow: 2px 2px 4px #000000; ">WEBSITE REGISTRASI PASIEN <br>SILAHKAN LOGIN!</br></h1>
            <div class ="container">
                 <table align="center">
            <tr>
            ...
            <tr>
                <td rowspan="1">
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" class="lgnbtn" Text="LOGIN" Width="181px" />
